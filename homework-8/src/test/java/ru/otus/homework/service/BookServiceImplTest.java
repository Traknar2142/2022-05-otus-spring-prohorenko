...
public class BookServiceImplTest {
    ...
    void shouldReturnSavedBook() {
        Author authorForSave = new Author("1", "George Orwell2");
        Genre genreForSave = new Genre("1", "Dystopia2");
        Book bookForSave = new Book("1", "1984-2", authorForSave, genreForSave);
    ...
    void shouldReturnBookById() {
        ...
        Mockito.when(bookRepository.findById("1")).thenReturn(Optional.of(bookForSave));
